                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    <input
                      ...
                      className="w-full rounded-2xl border border-neutral-200 bg-white px-4 py-3 pr-12 text-sm text-neutral-700 outline-none transition focus:border-neutral-400 focus:ring-2 focus:ring-[#c7f1d2]"
                    />
                    <button
                      type="button"
