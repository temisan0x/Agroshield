    ...
    >
      <div className="mx-auto w-full max-w-4xl px-6">
        <div className="flex items-center justify-between rounded-full bg-neutral-900/90 px-5 py-3 text-white shadow-sm backdrop-blur">
          <div className="flex items-center gap-3 font-[family-name:var(--font-manrope)] text-sm">
          ...
          <button className="rounded-full bg-white px-4 py-1.5 text-sm font-medium text-neutral-900">
            Get started
          </button>
        </div>
      </div>
