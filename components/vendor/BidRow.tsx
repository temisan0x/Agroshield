...
export default function BidRow({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`flex items-center justify-between gap-4 rounded-2xl px-5 py-4 transition-all duration-200 ${
        onClick ? "cursor-pointer hover:bg-white/60 hover:shadow-sm" : ""
      }`}
    >
